...
app.post('/productos', async (req, res) => {
  try {
    ...
    const result = await pool.query(
      'INSERT INTO productos (nombre, venta, costo, cantidad, precio_p, categoria, fecha_v, foto) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *',
...
app.put('/productos/:id', async (req, res) => {
  try {
    ...
    const { nombre, venta, costo, cantidad, precio_p, categoria, fecha_v, foto } = req.body;
    const result = await pool.query(
      `UPDATE productos SET nombre=$1, venta=$2, costo=$3, cantidad=$4, precio_p=$5, categoria=$6, fecha_v=$7, foto=$8 WHERE id=$9 RETURNING *`,
